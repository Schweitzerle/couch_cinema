import 'package:couch_cinema/screens/all_freinds_rated_movies.dart';
...
class FriendsRatedMovies extends StatelessWidget {
  final List ratedMovies;
  final List allRatedMovies;
  final Color buttonColor;

  const FriendsRatedMovies({Key? key, required this.ratedMovies, required this.allRatedMovies, required this.buttonColor}) : super(key: key);
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => AllFriendsRatedMovieScreen(
